...
from Classification.Utils.Layers import PARSeq_Encoder, DecoderLayer, PARSeq_Decoder, TokenEmbedding
...
if __name__ == "__main__":
    model = parseq(img_size=(32, 256), patch_size=[2, 4],
                   ...
                   decode_ar=True,refine_iters=1, dropout=0.1, max_label_length=40, character="椎间盘买股djljjksjfsdfsfsfsfds")
