...
"""
This is configuration of ocr model
@author:guiyingbin
@Time:2022/09/03
"""
class crnn_model_cfg:
    backbone_config = {
        "block1":
            [["Conv", 3, 64, 3, 1, 1],
             ["BatchNorm", 64],
...
if __name__ == "__main__":
    import pandas as pd
    path = r"D:\ocr_data\train_label.csv"
    data = pd.read_csv(path, encoding="gbk")
    print(len(crnn_model_cfg.alphabet))